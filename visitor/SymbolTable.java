...
class Class {
  ...
  return parent;
    ...
    public int getIndexOfVar(String id) {
      return ((Variable)globals.get(id)).getIndex();
    }
} // Class
...
class Variable {
  ...
  this.type = type;
    ...
    public void setAccess(Frame.Access a) {
      access = a;
    }
...
class Method {
  ...
  return null;
    ...
    public void setAccess(List<Frame.Access> access) {
      for (int i = 0; i < params.size(); i++)
        ((Variable)params.elementAt(i)).setAccess(access.get(i+1));
    }
